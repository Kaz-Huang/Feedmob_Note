  ...
  return (
    ...
    >
      ...
      <div className="relative group">
        ...
        {hoveredButton === 'plus' && (
          <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 z-50 px-2.5 py-1 rounded-md bg-slate-900 text-white text-[11px] font-medium whitespace-nowrap shadow-xl pointer-events-none animate-in fade-in zoom-in-95">
      ...
      {isMenuOpen && (
        <div
          ref={menuRef}
          className="absolute left-12 top-0 w-52 bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 p-1.5 flex flex-col gap-0.5 z-50 animate-in fade-in zoom-in-95 text-xs text-slate-700 dark:text-slate-300"
        >
          ...
          <button
            ...
            className="flex items-center gap-2 px-2.5 py-2 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-950/40 text-emerald-800 dark:text-emerald-300 font-semibold transition"
          >
          ...
          <button
            ...
            className="flex items-center justify-between px-2.5 py-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/40 text-red-600 transition"
          >
